...
inline float FastFloor(float x) { return static_cast<float>(int(x)) - static_cast<float>(x < 0 && x != int(x)); }
inline double FastFloor(double x) { return static_cast<double>((long long)(x)) - static_cast<double>(x < 0 && x != (long long)(x)); }
